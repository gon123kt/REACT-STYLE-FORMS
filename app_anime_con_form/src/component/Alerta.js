...
//el hook keyframe es para dar dinamismo a las alertas
...
const Alerta = ({tipo, mensaje, estadoAlerta, cambiarEstadoAlerta}) => {
    useEffect(() => {
        ...
        //Pasamos una func de limpieza. Esta func se ejecuta si el componente es verdadero
